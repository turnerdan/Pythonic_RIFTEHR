...
def the_work():
    ...
    no_conflicts['specific_relationship'] = np.where((no_conflicts.ec_relation == 'parent' ) & (no_conflicts.matched == 'M' ), 'father', no_conflicts['specific_relationship']) # flag fathers
